...
def main() -> None:
    ...
    preview = {
        ...
        "signature_type": int(getattr(order, "signatureType")),
        "maker": getattr(order, "maker"),
        "signer": getattr(order, "signer"),
        "maker_amount": getattr(order, "makerAmount"),
        "taker_amount": getattr(order, "takerAmount"),
